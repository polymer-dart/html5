...
class HTMLInputElement extends HTMLElement with MozImageLoadingContent, MozPhonetic {
    ...
    external set valueAsDate (Date val);
...
class File extends Blob {
    ...
    external Date get lastModifiedDate;
...
class HTMLMediaElement extends HTMLElement {
    ...
    external AudioChannel get mozAudioChannelType;
    external set mozAudioChannelType (AudioChannel val);
...
class CustomElementRegistry {
    external void define(String name,Function functionConstructor,ElementDefinitionOptions options);
